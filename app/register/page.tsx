    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[360px] space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-foreground/50">Join & start shopping in Tanzania 🇹🇿</p>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white text-gray-800 text-sm font-semibold hover:bg-white/90 transition-colors disabled:opacity-60"
          >
            {oauthLoading === "google" ? (
          ...
          <button
            ...
            disabled={!!oauthLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-foreground text-background text-sm font-semibold hover:opacity-90 transition-opacity disabled:opacity-60"
          >
            {oauthLoading === "apple" ? (
              <Loader2 className="h-4 w-4 animate-spin" />
            ) : (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-xs text-foreground/50 font-medium">Full name</label>
            <input
              type="text"
          ...
          <div className="space-y-1.5">
            <label className="text-xs text-foreground/50 font-medium">
              Phone number <span className="text-foreground/30">(for delivery & payments)</span>
            </label>
            <input
              type="tel"
          ...
          <p className="text-xs text-foreground/25">
            ...
            <a href="#" className="text-foreground/40 hover:text-foreground transition-colors underline">Terms</a>{" "}
            and{" "}
            <a href="#" className="text-foreground/40 hover:text-foreground transition-colors underline">Privacy Policy</a>.
          </p>
