      ...
      <div className="container mx-auto px-4 py-6 max-w-lg space-y-5">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={label} className="rounded-xl bg-white/[0.04] border border-white/6 p-2.5">
                      ...
                      <p className="text-[8px] text-foreground/28 font-mono mt-0.5">{label}</p>
                    </div>
                  ))}
                </div>
                {/* Add savings button */}
            ...
            {showSave && (
              <div className="mt-4 pt-4 border-t border-white/8 flex gap-2 items-end">
                <div className="flex-1">
                  <label className="text-[9px] font-mono tracking-widest text-foreground/35 block mb-1">AMOUNT SAVED SO FAR (TZS)</label>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <p className="text-[10px] font-mono tracking-widest text-foreground/35 uppercase">
            ...
            <Link href={`/products?wishlist=${goal.id}`}
              className="flex items-center gap-1 text-[9px] font-mono text-foreground/30 hover:text-foreground/60 transition-colors">
                ...
                return (
                  <div key={item.id} className="flex items-center gap-3.5 rounded-2xl border border-white/7 bg-white/[0.02] hover:bg-white/[0.035] transition-all p-3.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[9px] text-foreground/28 font-mono mt-0.5">{item.product.category.name}</p>
        ...
        {goal.items.length > 0 && (
          <div className={`rounded-2xl border ${c.border} ${c.bg} px-4 py-3 flex items-center justify-between`}>
            <div>
              <p className="text-[9px] font-mono text-foreground/35 uppercase tracking-widest">Total Cost</p>
